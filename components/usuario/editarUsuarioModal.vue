                ...
                .modal-container.uk-width-1-4
                    div(class="uk-grid", uk-grid)
                        div(class="uk-width-expand")
                            div
                                h5.uk-margin-remove.uk-text-center Editar Usuario
                    ...
                    form.uk-form
                        ...
                        .uk-margin-medium-top.uk-text-right
                            button.uk-button.primary-button( type="button" , @click="editar") Editar
</template>
...
export default {
      ...
      props: ['isOpen','id','nombreusuario','apellido','edad'],
    ...
    methods:{
      ...
      /*async editar(){
          ...
          await axios.put(`http://127.0.0.1:3333/api/v1/usuarios/actualizar/`, this.config,{
            ...
            ocupacion:this.config.ocupacion
                 ...
                 //this.$emit("closeModalActualizado");
